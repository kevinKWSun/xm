...
class Harm_model extends CI_model {
	...
	public function lists($page = 10, $per_page = 1, $admin_id = array()) {
		...
		$sql = $this->db->get('harmless');
		return $sql->result_array();
	}
	public function get_lnum($admin_id = array()){
		$this->db->where_in('admin_id', $admin_id);
        return  $this->db->count_all_results('harmless');
    }
...
//养殖场户->网格内的监管责任人->无害化处理车驾驶员->驻场兽医核查