...
<body>
    <div class="main-wrap">
        ...
        <form action="/yznews/stock" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPostAllS" data-href="/yznews/stock"><i class="fa fa-save"></i>提交</a>
