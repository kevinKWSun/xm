...
<body>
    <div class="main-wrap">
        <blockquote class="layui-elem-quote fhui-admin-main_hd">
            <h2>编辑养殖场信息 <a class="layui-btn layui-btn-small do-action" data-type="doShow" data-href="/ausers/bind.html"><i class="fa fa-plus"></i>绑定登录账号</a></h2>
        </blockquote>
        <form action="/yznews/yznewsadd" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
					...
					<div class="layui-input-inline" style="width: 100px;">
						<select name="addr_county" data-val="true" data-val-number="字段 Int32 必须是一个数字" data-val-required="Int32 字段是必需的" >
							...
							<?php foreach($county as $k=>$v) : ?>
								<option value="<?php echo $v['id']; ?>" <?php if($m['addr_county'] == $v['id']) { echo 'selected="selected"'; } ?>><?php echo $v['name']; ?></option>
							<?php endforeach; ?>
						</select>
					</div>
					<div class="layui-input-inline" style="width: 300px;">
						<input name="addr" autocomplete="off" lay-verify="required" placeholder="必填,养殖场地址" class="layui-input" type="text" value="<?php echo $m['addr'] ?>">
					</div>
				</div>
            </div>
				...
				<legend>养殖种类</legend>
					<div class="layui-input-block" style="margin-left:15px;">
						<?php foreach($cate as $k=>$v) { ?>
							<input type="checkbox" name="cate[<?php echo $k; ?>]" lay-skin="primary" title="<?php echo $v; ?>" value="<?php echo $k; ?>" <?php if(in_array($k, $m['cate'])) { echo 'checked="checked"'; } ?>/>
						<?php } ?>
					</div>
			</fieldset>
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<a class="layui-btn layui-btn-small" id="getvector"  data-href="/yznews/yznewsedit">选择</a>
				</div>
            </div>
			<div class="layui-form-item">
				<div class="layui-inline">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input name="phone" autocomplete="off" lay-verify="required" placeholder="必填,联系电话" class="layui-input" type="text" value="<?php echo $m['legal_phone']; ?>">
					</div>
				</div>
            </div>
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input name="charge_idcard" autocomplete="off" lay-verify="required" placeholder="必填,身份证号" class="layui-input" type="text" value="<?php echo $m['idcard']; ?>" />
					</div>
				</div>
            </div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="point" autocomplete="off" lay-verify="required" class="layui-input" type="text" value="<?php echo $m['point']; ?>">
				</div>
				<label class="layui-form-label">监管兽医</label>
				<div class="layui-input-inline">
					<input name="vet" autocomplete="off" lay-verify="required" placeholder="必选,监管兽医" class="layui-input" type="hidden" value="<?php echo $m['vet']; ?>">
				</div>
				<div class="layui-input-inline">
					<input class="layui-input" value="<?php echo $m['vet_name']['real_name']; ?>" />
				</div>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input name="prevent_num" autocomplete="off" lay-verify="required" placeholder="必选,防疫合格证" class="layui-input" type="text" value="<?php echo $m['prevent_num']; ?>">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">发放时间</label>
					<div class="layui-input-block">
						<input name="issuing_time" autocomplete="off" lay-verify="required" placeholder="必选,发放时间" id="issuing_time" lay-verify="date" placeholder="yyyy-MM-dd" class="Wdata layui-input" onclick="layui.laydate({elem: this})" type="text" value="<?php echo date('Y-m-d', $m['issuing_time']); ?>">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="pic" autocomplete="off" lay-verify="required" placeholder="必传,图片" class="layui-input" type="hidden" value="<?php echo $m['pic']; ?>">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/yznews/yznewsedit"><i class="fa fa-save"></i>提交</a>
