...
<body>
    <div class="main-wrap">
        ...
        <form action="/wzrknews/add" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			<div class="layui-form-item">
				...
				<input name="unit" lay-verify="required" value="<?php echo get_dig()[1]; ?>" autocomplete="off" class="layui-input" type="text" readonly />
				</div>
            </div>
            <div class="layui-form-item">
				<label class="layui-form-label">入库数量</label>
                <div class="layui-input-inline">
                    <input name="num" lay-verify="number" placeholder="必填,入库数量" autocomplete="off" class="layui-input" type="text" />
                </div>
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="batch_num" autocomplete="off" lay-verify="required" value="" placeholder="必填,生产批号" class="layui-input" type="text">
				</div>
				<label class="layui-form-label">签收单位</label>
				<div class="layui-input-inline">
					<input name="sign_uint" autocomplete="off" lay-verify="required" value="" placeholder="必填,签收单位" class="layui-input" type="text" readonly >
					<input name="sign_uint_id" autocomplete="off" lay-verify="required" value="" placeholder="必填,签收单位ID" class="layui-input" type="hidden">
				</div>
				<div class="layui-input-inline">
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="sign_person" autocomplete="off" lay-verify="required" value="" placeholder="必填,签收人" class="layui-input" type="text">
				</div>
				<label class="layui-form-label">入库时间</label>
				<div class="layui-input-inline">
					<input name="input_time" lay-verify="date" autocomplete="off" value="" placeholder="必填,入库时间" class="Wdata layui-input" type="text" onclick="layui.laydate({elem: this})" readonly>
				</div>
            </div>
			<div class="layui-form-item">
				<label class="layui-form-label">有效期至</label>
				<div class="layui-input-inline">
					<input name="expiry_time" lay-verify="date" autocomplete="off" value="" placeholder="必填,有效期" class="Wdata layui-input" type="text" onclick="layui.laydate({elem: this})" readonly>
				</div>
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/wzrknews/add"><i class="fa fa-save"></i>提交</a>
