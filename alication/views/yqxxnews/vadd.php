...
<body>
    <div class="main-wrap">
        ...
        <form action="/yqxxnews/add" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="times" lay-verify="required" placeholder="必填,报告时间" autocomplete="off" class="Wdata layui-input" onclick="layui.laydate({elem: this})" type="text" readonly />
				</div>
				<label class="layui-form-label">疫情地点</label>
				<div class="layui-input-inline">
					<input name="addr" lay-verify="required" placeholder="必填,地点" autocomplete="off" class="layui-input" type="text" />
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">单位/个人</label>
				<div class="layui-input-inline">
					<input name="unit" lay-verify="" placeholder="选填,单位/个人" autocomplete="off" class="layui-input" type="text" />
				</div>
				<label class="layui-form-label">联系方式</label>
				<div class="layui-input-inline">
					<input name="tel" lay-verify="" placeholder="选填,联系方式" autocomplete="off" class="layui-input" type="text" />
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">疑似疫病</label>
				<div class="layui-input-inline">
					<input name="suspected" lay-verify="required" placeholder="必填,疑似疫病" autocomplete="off" class="layui-input" type="text" />
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="cnumber" lay-verify="" placeholder="选填,存栏数量" id="date" autocomplete="off" class="layui-input" type="text" />
				</div>
				<label class="layui-form-label">发病数量</label>
				<div class="layui-input-inline">
					<input name="fnumber" lay-verify="required" placeholder="选填,发病数量" autocomplete="off" class="layui-input" type="text" />
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">死亡数量</label>
				<div class="layui-input-inline">
					<input name="number" lay-verify="" placeholder="选填,死亡数量" autocomplete="off" class="layui-input" type="text" />
				</div>
				<label class="layui-form-label">临床症状</label>
				<div class="layui-input-inline">
					<input name="symptom" lay-verify="" placeholder="选填,临床症状" id="" autocomplete="off" class="layui-input" type="text" />
				</div>
			</div>
            <!--底部工具栏-->
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/yqxxnews/add"><i class="fa fa-save"></i>提交</a>
