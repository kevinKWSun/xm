        ...
        <form action="/jymessage/jyadd" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-inline">
						...
						<div class="layui-input-block">
							<input name="estab_time" autocomplete="off" lay-verify="required" placeholder="必选,发放时间" id="issuing_time" lay-verify="date" placeholder="yyyy-MM-dd" class="Wdata layui-input" onclick="layui.laydate({elem: this})" type="text">
						</div>
					</div>
				</div>
            </div>
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input name="license" autocomplete="off" lay-verify="required" placeholder="必填,兽药许可证编号" class="layui-input" type="text">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">发证时间</label>
					<div class="layui-input-block">
						<input name="license_begin" autocomplete="off" lay-verify="required" placeholder="必选,发证时间" id="issuing_time" lay-verify="date" placeholder="yyyy-MM-dd" class="Wdata layui-input" onclick="layui.laydate({elem: this})" type="text">
					</div>
				</div>
				<div class="layui-inline">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="pic" autocomplete="off"  class="layui-input" type="hidden">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/jymessage/jyadd"><i class="fa fa-save"></i>提交</a>
                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-href=""><i class="fa fa-refresh fa-spin"></i>刷新</a>
                        <a class="layui-btn layui-btn-small do-action" data-type="doGoBack" data-href="/jynews/index"><i class="fa fa-mail-reply"></i>返回上一页</a>
