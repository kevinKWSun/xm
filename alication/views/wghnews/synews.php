                            ...
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAdd" data-href="/wghnews/add.html">
                                            <i class="fa fa-plus"></i>新增
                                        </a>
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/wghnews/sh.html">
                                            <i class="fa fa-refresh"></i>审核通过
                                        </a>
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/wghnews/desh.html">
                                            <i class="fa fa-refresh"></i>审核不通过
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-href="/wghnews.html">
                    ...
                    <table class="layui-table layui-tables" lay-skin="line">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $v['tunit']; ?></td>
                                <td><?php echo $v['unit'] ?></td>
								<td><?php echo $v['admin'] ?></td>
								<td><?php echo $v['jname'] ?></td>
								<td><?php echo $v['tel'] ?></td>
                                <td>
                                    <!--a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/wghnews/edit/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>编辑</a-->　
									<a class="layui-btn layui-btn-small do" data-type="doEdit" data-href="/wghnews/show/<?php echo $v['id']; ?>.html"><i class="fa fa-search"></i>查看</a>
								</td>
                            </tr>
                            <?php endforeach;} ?>
                        </tbody>
    ...
    <script>
        layui.use(['layer', 'laypage', 'common', 'form', 'paging'], function () {
            ...
            form.on('submit(cx)', function (data) {
                ...
                $.post('/wghnews/solor.html', { keywords: keywords },
                function (result, status) {
                    if (result.state == 1) {
                        window.location.href = '/wghnews/solor/1?query=' + result.message;//result.data;
                    }else{
