                            ...
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAdd" data-href="/scmessage/scadd.html">
                                            <i class="fa fa-plus"></i>新增
                                        </a><!-- 
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/ausers">
                                            <i class="fa fa-edit"></i>初始化密码
                                        </a> -->
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/scmessage/lock.html">
                                            <i class="fa fa-lock"></i>关闭
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/scmessage/unlock.html">
                                            <i class="fa fa-unlock"></i>开启
                                        </a>
                                        <!-- <a class="layui-btn layui-btn-small do-action" data-type="doDelete" data-href="/ausers/del.html">
                                            <i class="fa fa-trash-o"></i>删除
                                        </a> -->
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/scmessage/sh.html">
                                            <i class="fa fa-refresh"></i>审核通过
                                        </a>
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/scmessage/desh.html">
                                            <i class="fa fa-refresh"></i>审核不通过
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-href="/scmessage/index.html">
                    ...
                    <table class="layui-table" lay-skin="line">
                        ...
                        <tbody>
							...
							<tr>
								...
								<td>
									 <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/scmessage/scedit/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>编辑</a>　
								</td>
								<td>
									<a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/scmessage/scdetail/<?php echo $v['id']; ?>.html"><i class="fa fa-search"></i>查看</a>
								</td>
							</tr>
							<?php } ?>
                        </tbody>
    ...
    <script>
        layui.use(['layer', 'laypage', 'common', 'form', 'paging'], function () {
            ...
            form.on('submit(cx)', function (data) {
                ...
                $.post('/scmessage/solor', { keywords: keywords },
                function (result, status) {
                    if (result.state == 1) {
                        window.location.href = '/scmessage/solor/1?query=' + result.message;//result.data;
                    }else{
