    ...
    <div class="main-wrap">
        ...
        <div class="y-role">
            ...
            <div class="fhui-admin-table-container" id='myPrintArea'>
                <div class="layui-form-item"><center>兽药企业生产详情</center></div>
                <table class="layui-table layui-tables" lay-skin="line" boder='1'>
                    <tbody>
                        <tr>
                            ...
                            <td><b>编号</b></td>
                            <td><?php echo 'YTSYJY' . str_pad($ms['id'],6,'0',STR_PAD_LEFT); ?></td>
                        </tr>
						<tr>
                            <td><b>注册地址</b></td>
