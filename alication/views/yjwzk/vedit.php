...
<body>
    <div class="main-wrap">
        ...
        <form action="/yjwzk/edit" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input name="lname" lay-verify="required" placeholder="必填,物资库名称" autocomplete="off" class="layui-input" type="text" value="<?php echo $m['lname'];?>" />
                </div>
            </div>
			<div class="layui-form-item">
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="real_name" autocomplete="off" lay-verify="required" value="<?php echo $m['real_name'];?>" placeholder="必填,负责人真实姓名" class="layui-input" type="text">
				</div>
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/yjwzk/edit"><i class="fa fa-save"></i>提交</a>
