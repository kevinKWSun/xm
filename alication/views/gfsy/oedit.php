...
<body>
    <div class="main-wrap">
        <blockquote class="layui-elem-quote fhui-admin-main_hd">
            <h2>编辑官方兽医　<a class="layui-btn layui-btn-small do-action" data-type="doShow" data-href="/ausers/bind.html"><i class="fa fa-plus"></i>绑定登录账号</a></h2>
        ...
        <form action="/gfsy/add" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input name="university" autocomplete="off" lay-verify="required" value="<?php echo $m['university'];?>" placeholder="必填,毕业院校" class="layui-input" type="text">
					</div>
				</div>
            </div>
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select data-val="true" data-val-number="字段 Int32 必须是一个数字" data-val-required="Int32 字段是必需的" name="education">
							...
							<option value="<?php echo $k; ?>" <?php if($m['education'] == $k){echo ' selected';}?>><?php echo $v; ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input name="approval_time" lay-verify="date" autocomplete="off" value="<?php echo date('Y-m-d', $m['approval_time']);?>" placeholder="必填,批准时间" class="Wdata layui-input" onclick="layui.laydate({elem: this})" type="text" readonly>
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">备注</label>
					<div class="layui-input-inline">
						<input name="remark" autocomplete="off" lay-verify="" value="<?php echo $m['remark'];?>" placeholder="先填,备注" class="layui-input" type="text">
					</div>
				</div>
            </div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
					  <input name="cancel" value="1" title="是" type="radio" <?php if($m['cancel'] == 2){echo 'checked';}?> />
					  <input name="cancel" value="2" title="否" type="radio" <?php if($m['cancel'] == 2){echo 'checked';}?> />
					</div>
				</div>
				<div class="layui-inline zxtime" style='display:none;'>
					<label class="layui-form-label">注销时间</label>
					<div class="layui-input-inline">
						<input name="cancel_time" autocomplete="off" lay-verify="" value="<?php echo $m['cancel_time'] ? date('Y-m-d', $m['cancel_time']):'';?>" placeholder="必填,注销时间" class="layui-input Wdata" onclick="layui.laydate({elem: this})" type="text" readonly>
					</div>
				</div>
            </div>
            <!--底部工具栏-->
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/gfsy/edit"><i class="fa fa-save"></i>提交</a>
