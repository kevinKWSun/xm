...
<body>
    <div class="main-wrap">
        <blockquote class="layui-elem-quote fhui-admin-main_hd">
            <h2>编辑散养户基本信息　<a href='javascript:;' id='photo'>查看图片</a></h2>
        </blockquote>
        <form action="/synews/edit" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/synews/edit"><i class="fa fa-save"></i>提交</a>
