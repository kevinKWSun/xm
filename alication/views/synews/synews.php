                            ...
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAdd" data-href="/synews/add.html">
                                            <i class="fa fa-plus"></i>新增
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/synews/lock.html">
                                            <i class="fa fa-lock"></i>关闭
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/synews/unlock.html">
                                            <i class="fa fa-unlock"></i>开启
                                        </a>
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/synews/sh.html">
                                            <i class="fa fa-refresh"></i>审核通过
                                        </a>
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/synews/desh.html">
                                            <i class="fa fa-refresh"></i>审核不通过
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-href="/synews.html">
                    ...
                    <table class="layui-table layui-tables" lay-skin="line">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo 'YTSYH' . str_pad($v['id'],6,'0',STR_PAD_LEFT); ?></td>
								<td><?php echo $v['area'] ?></td>
                                <td><?php echo $v['phone']; ?></td>
                                <td><?php echo $v['card'] ?></td>
								<td><?php echo $v['vname'] ?></td>
								<td><?php echo ($v['camera']==1) ? '有' : '无'; ?></td>
                                ...
                                <td><?php if($v['status']!=1){?>
                                    <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/synews/edit/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>编辑</a>　
								<?php }?>
									<a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/synews/sedit/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>详细</a>
                                </td>
								<td>
								<a class="layui-btn layui-btn-small do" data-type="doEdit" data-href="/synews/show/<?php echo $v['id']; ?>.html"><i class="fa fa-search"></i>查看</a>
								</td>
                            </tr>
                            <?php endforeach;} ?>
                        </tbody>
    ...
    <script>
        layui.use(['layer', 'laypage', 'common', 'form', 'paging'], function () {
            ...
            form.on('submit(cx)', function (data) {
                ...
                $.post('/synews/solor.html', { keywords: keywords },
                function (result, status) {
                    if (result.state == 1) {
                        window.location.href = '/synews/solor/1?query=' + result.message;//result.data;
                    }else{
