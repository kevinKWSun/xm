...
<body>
    <div class="main-wrap">
        <blockquote class="layui-elem-quote fhui-admin-main_hd">
            <h2>编辑动物诊疗机构信息　<a href='javascript:;' id='photo'>查看图片</a></h2>
        </blockquote>
        <form action="/jgnews/edit" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input name="num" lay-verify="required" placeholder="必填,机构名称" autocomplete="off" class="layui-input" type="text" value="<?php echo $m['num'];?>" />
                </div>
            </div>
			<div class="layui-form-item">
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="leader" autocomplete="off" lay-verify="required" value="<?php echo $m['leader'];?>" placeholder="必填,法人代表" class="layui-input" type="text">
				</div>
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select data-val="true" data-val-number="字段 Int32 必须是一个数字" data-val-required="Int32 字段是必需的" name="type">
						<option value="1" <?php ($m['type']==1)?' selected':'';?>>动物医院</option>
						<option value="2" <?php ($m['type']==2)?' selected':'';?>>动物诊所</option>
					</select>
				</div>
				<label class="layui-form-label">执业人数</label>
				<div class="layui-input-inline">
					<input name="number" lay-verify="number" autocomplete="off" value="<?php echo $m['number'];?>" placeholder="必填,执业兽医人数" class="layui-input" type="text">
				</div>
            </div>
			<div class="layui-form-item">
				<label class="layui-form-label">狂犬病定点</label>
				<div class="layui-input-inline">
					<input name="point" value="1" title="是" type="radio" <?php echo $m['point']?' checked':'';?> />
					<input name="point" value="0" title="否" type="radio" <?php echo $m['point']?'':' checked';?> />
				</div>
				<label class="layui-form-label">许可证编号</label>
				<div class="layui-input-inline">
					<input name="license" autocomplete="off" lay-verify="required" value="<?php echo $m['license'];?>" placeholder="必填,许可证编号" class="layui-input" type="text">
				</div>
            </div>
			<div class="layui-form-item">
				<label class="layui-form-label">发证日期</label>
				<div class="layui-input-inline">
					<input name="ftime" autocomplete="off" lay-verify="date" value="<?php echo date('Y-m-d',$m['ftime']);?>" placeholder="选选,发证日期" class="layui-input" type="text" readonly onclick="layui.laydate({elem: this})">
				</div>
				<label class="layui-form-label">诊疗许可证</label>
				<div class="layui-input-inline">
					<input name="pic" autocomplete="off" lay-verify="required" value="<?php echo $m['pic'];?>" placeholder="必传,诊疗许可证图片" class="layui-input" type="hidden">
            ...
            <div class="layui-form-item" style="width: 609px;">
                <textarea class="layui-textarea" name="remark" placeholder="选填,主要仪器设备"><?php echo $m['remark'];?></textarea>
            </div>
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/jgnews/edit"><i class="fa fa-save"></i>提交</a>
