                            ...
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAdd" data-href="/ausers/add.html">
                                            <i class="fa fa-plus"></i>新增
                                        </a><!-- 
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/ausers">
                                            <i class="fa fa-edit"></i>初始化密码
                                        </a> -->
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/ausers/lock.html">
                                            <i class="fa fa-lock"></i>锁定
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/ausers/unlock.html">
                    ...
                    <table class="layui-table" lay-skin="line">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($v['name']=='admin'){echo '超管';}else{echo $v['gid']?$v['gid']:'无';} ?></td>
                                <td align="center">
                                	<?php if($v['type'] == 1){ ?>
                                ...
                                <td>
                                    <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/ausers/edit/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>编辑</a>
                                </td>
                            </tr>
                            <?php endforeach;} ?>
                        </tbody>
        ...
        layui.use(['layer', 'laypage', 'common', 'form', 'paging'], function () {
            ...
            form.on('submit(cx)', function (data) {
                ...
                function (result, status) {
                    if (result.state == 1) {
                        window.location.href = '/ausers/solor/1?query=' + result.message;//result.data;
                    }else{
