                            ...
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAdd" data-href="/rule/add.html">
                    ...
                    <table class="layui-table" lay-skin="line">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/rule/edit/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>编辑</a>
                                    <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/rule/addall/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-plus"></i>增加</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/rule/edit/<?php echo $vs['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>编辑</a>
                                    <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/rule/addall/<?php echo $vs['id']; ?>.html"><i class="icon-edit  fa fa-plus"></i>增加</a>
                                </td>
                            </tr>
    ...
    <script>
        layui.use(['layer', 'laypage', 'common', 'form', 'paging'], function () {
            ...
            form.on('submit(cx)', function (data) {
                ...
                $.post('/rule/solor', { keywords: keywords },
                function (result, status) {
                    if (result.state == 1) {
                        window.location.href = '/rule/solor/1?query=' + result.message;//result.data;
                    }else{
