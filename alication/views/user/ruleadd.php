...
<body>
    <div class="main-wrap">
        ...
        <form action="/rule/add" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/rule/add"><i class="fa fa-save"></i>提交</a>
