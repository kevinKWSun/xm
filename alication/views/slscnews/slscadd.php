...
<body>
    <div class="main-wrap">
        ...
        <form action="/slscnews/clscadd" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<a class="layui-btn layui-btn-small" id="getvector"  data-href="/slscnews/slscadd">选择</a>
				</div>
            </div>
			<div class="layui-form-item">
				<div class="layui-inline">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input name="origin" autocomplete="off" lay-verify="required" placeholder="必填,有无动物源性产品" class="layui-input" maxlength="45" type="text">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">原料来源地</label>
					<div class="layui-input-block">
						<input name="source" autocomplete="off" lay-verify="required" placeholder="必填,动物源性原料来源地" class="layui-input" maxlength="45" type="text">
					</div>
				</div>
            </div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input name="sale_addr" autocomplete="off" lay-verify="required" placeholder="必填,主要销售地区" class="layui-input" maxlength="45" type="text">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">销售形式</label>
					<div class="layui-input-block">
						<input name="sale_type" autocomplete="off" lay-verify="required" placeholder="必填,销售形式" class="layui-input" maxlength="45" type="text">
					</div>
				</div>
            </div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input name="varieties" autocomplete="off" lay-verify="required" placeholder="必填,产品品种" class="layui-input" maxlength="45" type="text">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">有无定制产品</label>
					<div class="layui-input-block">
						<input name="made" autocomplete="off" lay-verify="required" placeholder="必填,有无定制产品" class="layui-input" maxlength="45" type="text">
					</div>
				</div>
            </div>
			<div class="layui-form-item">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/slscnews/slscadd"><i class="fa fa-save"></i>提交</a>
