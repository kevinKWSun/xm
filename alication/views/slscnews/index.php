                            ...
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAdd" data-href="/slscnews/slscadd.html">
                                            <i class="fa fa-plus"></i>新增
                                        </a><!-- 
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/ausers">
                                            <i class="fa fa-edit"></i>初始化密码
                                        </a> -->
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/slscnews/lock.html">
                                            <i class="fa fa-lock"></i>关闭
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/slscnews/unlock.html">
                                            <i class="fa fa-unlock"></i>开启
                                        </a>
                                        <!-- <a class="layui-btn layui-btn-small do-action" data-type="doDelete" data-href="/ausers/del.html">
                                            <i class="fa fa-trash-o"></i>删除
                                        </a> -->
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/slscnews/sh.html">
                                            <i class="fa fa-refresh"></i>审核通过
                                        </a>
										<a class="layui-btn layui-btn-small do-action" data-type="doAction" data-href="/slscnews/desh.html">
                                            <i class="fa fa-refresh"></i>审核不通过
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-href="/slscnews/index.html">
            ...
            <div class="fhui-admin-table-container">
                <form class="form-horizontal" id="formrec" method="post" role="form">
                    <table class="layui-table" lay-skin="line">
                        ...
                        <tbody>
							<?php foreach ($slscnews as $v) { ?>
							<tr>
								<td>
                                    <input id="ck" ids="<?php echo $v['id']; ?>" name="ck" type="checkbox" value="true" />
                                </td>
								<td><?php echo $v['name']; ?></td>
                                <td><?php echo 'YTSLSC' . str_pad($v['id'],6,'0',STR_PAD_LEFT); ?></td>
                                <td><?php echo $v['reg_area']; ?></td>
                                <td><?php echo $v['legal_name']; ?></td>
								<td><?php echo $v['legal_phone']; ?></td>
								<!--<td><?php echo $v['origin']; ?></td>
								<td><?php echo $v['source']; ?></td>-->
								<td><?php if($v['reg_time']) { echo date('Y-m-d', $v['reg_time']); } ?></td>
								<td><?php echo $v['license']; ?></td>
								<td><?php if($v['reg_time']) { echo date('Y-m-d', $v['license_time']); } ?></td>
								<td><?php echo $v['sale_addr']; ?></td>
								<td><?php echo $v['varieties']; ?></td>
								<td><?php echo $v['made']; ?></td>
								...
								<td>
									 <a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/slscnews/slscedit/<?php echo $v['id']; ?>.html"><i class="icon-edit  fa fa-pencil-square-o"></i>编辑</a>　
								</td>
								<td>
									<a class="layui-btn layui-btn-small do-action" data-type="doEdit" data-href="/slscnews/slscdetail/<?php echo $v['id']; ?>.html"><i class="fa fa-search"></i>查看</a>
								</td>
							</tr>
							<?php } ?>
                        </tbody>
    ...
    <script>
        layui.use(['layer', 'laypage', 'common', 'form', 'paging'], function () {
            ...
            form.on('submit(cx)', function (data) {
                ...
                $.post('/slscnews/solor', { keywords: keywords },
                function (result, status) {
                    if (result.state == 1) {
                        window.location.href = '/slscnews/solor/1?query=' + result.message;//result.data;
                    }else{
