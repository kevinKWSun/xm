...
<html>
	<head>
		<meta charset="UTF-8">
		<title>安全生产日志</title>
		<meta name="keywords" content="安全生产日志">
		<meta name="description" content="安全生产日志">
...
<body>
	<section>
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
			<legend>日志列表　<a href='<?php echo base_url('wxsafe/add'); ?>'><button class="layui-btn layui-btn-small">新增日志</button></a></legend>
		</fieldset>
	</section>
	<section>
				...
				<tr>
					<?php foreach($lists as $k=>$v) : ?>
						<tr>
							...
							<td><a  href='<?php echo base_url('/wxsafe/art/'.$v['id']); ?>'>查看</a></td>
						</tr>
					<?php endforeach ?>
				</tr>
			</tbody>
	...
	<script>
		$(function() {
			$('#listsview').click(function() {
				...
				$.get(url, {}, function(r) {alert(r.html);
					if(r.html) {
