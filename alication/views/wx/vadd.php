...
<body>
    <div class="main-wrap">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
			<legend>增加散养户基本信息</legend>
		</fieldset>
        <form action="/wxsynews/add" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input name="num" lay-verify="required" placeholder="必填,种畜禽场名称" autocomplete="off" class="layui-input" type="text" />
                </div>
            </div>
			<div class="layui-form-item">
                <label class="layui-form-label">经度</label>
                <div class="layui-input-inline">
                    <input id='jname' name="lng" lay-verify="required" disabled='true' placeholder="必选,经度" autocomplete="off" class="layui-input" type="text" />
                </div>
				<label class="layui-form-label">纬度</label>
                <div class="layui-input-inline">
                    <input id='wname' name="lat" lay-verify="required" disabled='true' placeholder="必选,纬度" autocomplete="off" class="layui-input" type="text" /> 
                </div>
            </div>
            <div class="layui-form-item">
				<label class="layui-form-label">真实名称</label>
				<div class="layui-input-inline">
					<input name="real_name" autocomplete="off" lay-verify="required" value="" placeholder="必填,管理者真实姓名" class="layui-input" type="text">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="camera" value="1" title="有" type="radio" checked="" />
					<input name="camera" value="2" title="无" type="radio" />
				</div>
				<label class="layui-form-label">监管兽医</label>
				<div class="layui-input-inline">
					<input name="vet" autocomplete="off" lay-verify="required" value="" placeholder="必选,监管兽医" class="layui-input" type="hidden">
				</div>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="remark" autocomplete="off" lay-verify="" value="" placeholder="选填,备注" class="layui-input" type="text">
				</div>
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-href="/wxsynews/add"><i class="fa fa-save"></i>提交</a>
