...
<html>
	<head>
		<meta charset="UTF-8">
		<title>日志详情</title>
		<meta name="keywords" content="日志详情">
		<meta name="description" content="日志详情">
...
<body>
	...
	<section style="padding-bottom: 70px;">
		<table class="layui-table" lay-filter="demo">
			<tbody>
				<tr>
					<th>姓名</th>
					<td><?php echo $res['realname']['realname']; ?></td>
				</tr>
				<tr>
					<th>时间</th>
					<td><?php if($res['addtime']) { echo date('Y-m-d H:i', $res['addtime']); } ?></td>
				</tr>
				<tr>
					<th>备注</th>
	...
	<script>
		$(function(){
			...
			//设置显示地图的中心点和级别
			map.centerAndZoom(new T.LngLat(<?php echo $res['longitude'],', ',$res['latitude'];?>), zoom);
			//创建标注对象
			var marker = new T.Marker(new T.LngLat(<?php echo $res['longitude'],', ',$res['latitude'];?>));
			//向地图上添加标注
