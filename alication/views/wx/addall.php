    ...
    <div class="main-wrap">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
			<legend>增加散养户详情 　
                ...
                <a href='javascript:;' class='a_del'><font color='red'>减</font></a></legend>
		</fieldset>
        <form action="/wxsynews/sedit" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPostAllS" data-href="/wxsynews/sedit"><i class="fa fa-save"></i>提交</a>
