			...
			<div class="layui-form-item layui-form-text">
			 ...
			 <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input name="name" lay-verify="required" placeholder="必填,名称" autocomplete="off" class="layui-input" type="text" />
                </div>
            </div>
			<div class="layui-form-item layui-form-text">
	...
	<script type="text/javascript">
		$(function(){
			$('#sy-submit').click(function() {
				$.post('<?php echo base_url('wxsafe/add'); ?>', $('#sy-form').serialize(), function(r) {
					layer.open({
						content: r.message
						,skin: 'msg'
						,time: 2
					...
					if(r.state == 1) {
						location.href = '<?php echo base_url('wxsafe'); ?>';
					}
				}, 'json');
			});
		});
