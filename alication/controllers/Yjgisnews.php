...
class Yjgisnews extends MY_Controller {
	public function __construct() {
        parent::__construct();
        $this->load->model(array('yjgisnews/synews_model', 'area/area_model'));
	...
	public function index(){
		...
		$per_page = 8;
        $offset = $current_page;
        $config['base_url'] = base_url('yjgisnews/index');
        $config['total_rows'] = $this->synews_model->get_solor_num('');
        ...
        $data['p'] = $current_page;
        $synews = $this->synews_model->synews('', '', $per_page, $offset * $per_page);
		$data['synews'] = $synews;
		$this->load->view('yjgisnews/index', $data);
	}
	public function add(){
	...
	public function edit(){
		...
		$dat['m'] = $this->synews_model->get_m($id);
		$this->load->view('yjgisnews/edit', $dat);
	}
	public function solor(){
		...
		$per_page = 8;
        $offset = $current_page;
        $config['base_url'] = base_url('yjgisnews/solor');
	...
	public function show(){
		...
		$this->load->view('yjgisnews/show', $data);
	}
	public function report(){
		...
		$per_page = 8;
        $offset = $current_page;
        $config['base_url'] = base_url('yjgisnews/report');
        $config['total_rows'] = $this->synews_model->getreport_sum($keywords);
        $config['per_page'] = $per_page;
		$config['page_query_string'] = FALSE;
		$config['first_link'] = '首页'; // 第一页显示   
		$config['last_link'] = '末页'; // 最后一页显示   
        ...
        $data['page'] = $this->pagination->create_links();
        $data['p'] = $current_page;
        $synews = $this->synews_model->getreport($keywords, $per_page, $offset * $per_page);
        ...
        $data['synews'] = $synews;
		$this->load->view('yjgisnews/report', $data);
	}
	public function farm(){
		...
		$per_page = 8;
        $offset = $current_page;
        $config['base_url'] = base_url('yjgisnews/farm');
        ...
        $data['synews'] = $synews;
		$this->load->view('yjgisnews/farm', $data);
	}
	public function gis(){
		$keywords = $this->input->post_get('keywords', TRUE);
		if($this->input->post()){
		...
		$per_page = 100;
        $offset = $current_page;
        $config['base_url'] = base_url('yjgisnews/gis');
        $config['total_rows'] = $this->synews_model->get_solor_num($keywords);
        $config['per_page'] = $per_page;
		$config['page_query_string'] = FALSE;
		$config['first_link'] = '首页'; // 第一页显示   
        ...
        $data['ms'] = $synews;
		$this->load->view('yjgisnews/gis', $data);
	}
}