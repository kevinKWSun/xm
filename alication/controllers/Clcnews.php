...
class Clcnews extends MY_Controller {
	public function __construct() {
        parent::__construct();
        $this->load->model(array('clcnews/synews_model', 'area/area_model'));
	...
	public function index(){
        ...
        $data['synews'] = $synews;
		$this->load->view('clcnews/synews', $data);
	}
	public function add(){
		...
		$this->load->view('clcnews/vadd', $dat);
	}
	public function edit(){
		...
		$this->load->view('clcnews/vedit', $dat);
	}
	...
	public function show(){
		...
		$this->load->view('clcnews/show', $data);
	}
}