...
class Synews extends MY_Controller {
	...
	public function index(){
		...
		$per_page = 8;
        $offset = $current_page;
        $config['base_url'] = base_url('synews/index');
        ...
        $data['synews'] = $synews;
		$this->load->view('synews/synews', $data);
	}
	public function add(){
		...
		$this->load->view('synews/vadd', $dat);
	}
	public function edit(){
		...
		$this->load->view('synews/vedit', $dat);
	}
	public function solor(){
		...
		$per_page = 8;
        $offset = $current_page;
        $config['base_url'] = base_url('synews/solor');
	...
	public function show(){
		...
		$this->load->view('synews/show', $data);
	}
}